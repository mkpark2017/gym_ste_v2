...
if __name__ == "__main__":
    ...
    parser.add_argument('--rate', default=0.00003, type=float, help='learning rate')
    parser.add_argument('--prate', default=0.000003, type=float, help='policy net learning rate (only for DDPG)')
    parser.add_argument('--discount', default=0.90, type=float, help='Discount factor for next Q values')
    parser.add_argument('--init_w', default=0.003, type=float, help='Initial network weight')
    parser.add_argument('--tau', default=0.00003, type=float, help='moving average for target network')
    ...
    parser.add_argument('--output', default='output_ddpg_pf_3layers_0806_20points', type=str, help='Output root')
