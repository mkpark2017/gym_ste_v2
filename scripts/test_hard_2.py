...
def test(num_episodes, agent, env, evaluate, model_path, visualize=True, debug=False):
    agent.load_weights('output_ddpg_3layers_0809/gym_ste:SteHardEnv-v0-run2')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--env', default='gym_ste:SteVeryHardEnv-v0', type=str, help='open-ai gym environment')
    ...
    parser.add_argument('--debug', default='true', dest='debug', action='store_true', help='Debug')
    ...
    if args.resume == 'default':
        args.resume = 'output_ddpg_3layers_0809/{}-run2'.format(args.env)
