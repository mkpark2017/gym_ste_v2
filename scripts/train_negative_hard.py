...
if __name__ == "__main__":
    ...
    parser.add_argument('--env', default='gym_ste:SteNegativeHardEnv-v0', type=str, help='open-ai gym environment')
    ...
    parser.add_argument('--output', default='output_ddpg_3layers_0811_negative_reward', type=str, help='Output root')
