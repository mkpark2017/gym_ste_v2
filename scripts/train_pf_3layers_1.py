...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_iter', default=50000000, type=int, help='Total number of steps for training')
    #tain iter 1e6
    ...
    # validate 2e4
    parser.add_argument('--epsilon', default=4000000, type=int, help='linear decay of exploration policy')
    # epsilon 5e4
    ...
    parser.add_argument('--output', default='output_ddpg_pf_3layers_0805', type=str, help='Output root')
