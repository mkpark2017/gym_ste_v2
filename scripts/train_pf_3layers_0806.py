...
if __name__ == "__main__":
    ...
    parser.add_argument('--env', default='gym_ste:StePFilterHardEnv-v0', type=str, help='open-ai gym environment')
    ...
    parser.add_argument('--output', default='output_ddpg_pf_3layers_0806', type=str, help='Output root')
