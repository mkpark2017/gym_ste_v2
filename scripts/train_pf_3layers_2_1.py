...
#            print(action)
        ...
        if highest_reward < validate_reward == 0:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--env', default='gym_ste:StePFilterConvHardEnv2-v0', type=str, help='open-ai gym environment')
    ...
    parser.add_argument('--prate', default=0.000001, type=float, help='policy net learning rate (only for DDPG)')
    ...
    parser.add_argument('--tau', default=0.00001, type=float, help='moving average for target network')
    # Set learning parameter
    parser.add_argument('--warmup', default=200000, type=int, help='time without training but only filling the replay memory')
    #warmup 5e5
    parser.add_argument('--rmsize', default=200000, type=int, help='Memory size, after exceeding this limits, older entries will be replaced by newer ones')
    #repeat memory 1e7
    ...
    parser.add_argument('--output', default='output_ddpg_pf_3layers_0809_300points', type=str, help='Output root')
    ...
    if args.resume == 'default':
        args.resume = 'output_ddpg_pf_3layers_0806_20points/{}-run1'.format(args.env)
