...
def test(num_episodes, agent, env, evaluate, model_path, visualize=True, debug=False):
    agent.load_weights('output_ddpg_3layers_0811_est/gym_ste:SteEstHardEnv-v0-run2')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--warmup', default=10000000, type=int, help='time without training but only filling the replay memory')
    #warmup 5e5
