...
if __name__ == "__main__":
    ...
    #warmup 5e5
    parser.add_argument('--rmsize', default=3000000, type=int, help='Memory size, after exceeding this limits, older entries will be replaced by newer ones')
    #repeat memory 1e7
    ...
    parser.add_argument('--output', default='output_ddpg_3layers', type=str, help='Output root')
    ...
    if args.resume == 'default':
        args.resume = 'output_ddpg_pf_3layers_0804/{}-run4'.format(args.env)
