...
import numpy as np
import math
from gym_ste.envs.ste_pf_converge_base import *
...
class StePFilterConvHardEnv(StePFilterConvBaseEnv):
    ...
    def _set_init_state(self):
        ...
        self.wind_mean_phi = self.np_random.uniform(low=wind_angle-45, high=wind_angle+45)        # mean wind direction
...
register(
    id='StePFilterConvHardEnv-v0',
    entry_point='gym_ste.envs:StePFilterConvHardEnv',
)
