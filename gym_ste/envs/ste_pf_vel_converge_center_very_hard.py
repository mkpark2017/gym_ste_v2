...
class StePFilterVelConvCenterVeryHardEnv(StePFilterVelConvCenterBaseEnv):
...
register(
    id='StePFilterVelConvCenterVeryHardEnv-v0',
    entry_point='gym_ste.envs:StePFilterVelConvCenterVeryHardEnv',
)
