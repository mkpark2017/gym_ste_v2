...
import numpy as np
import math
from gym_ste.envs.ste_pf_vel_converge_center_base import *
...
class StePFilterVelConvCenterExtremeMatEnv(StePFilterVelConvCenterBaseEnv):
    metadata = {'render.modes': ['human', 'ansi'],
                'video.frames_per_second': 30}

    def __init__(self):
        StePFilterVelConvCenterBaseEnv.__init__(self)

        mat_file = scipy.io.loadmat('/root/gym-ste/gym_ste/envs/mat_files/random_states_rate.mat')
    ...
    def _set_init_state(self):
        ...
        StePFilterVelConvCenterBaseEnv._set_init_state(self)
...
register(
    id='StePFilterVelConvCenterExtremeMatEnv-v0',
    entry_point='gym_ste.envs:StePFilterVelConvCenterExtremeMatEnv',
)
