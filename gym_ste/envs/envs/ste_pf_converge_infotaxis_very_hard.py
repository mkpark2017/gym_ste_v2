...
class StePFilterConvInfotaxisVeryHardEnv(StePFilterConvInfotaxisBaseEnv):
...
register(
    id='StePFilterConvInfotaxisVeryHardEnv-v0',
    entry_point='gym_ste.envs:StePFilterConvInfotaxisVeryHardEnv',
)
