...
import numpy as np
import math
from gym_ste.envs.ste_negative_base import *
...
class SteNegativeHardEnv(SteNegativeBaseEnv):
    metadata = {'render.modes': ['human', 'ansi'],
                'video.frames_per_second': 30}

    def __init__(self):
        SteEstBaseEnv.__init__(self)
...
register(
    id='SteNegativeHardEnv-v0',
    entry_point='gym_ste.envs:SteNegativeHardEnv',
)
