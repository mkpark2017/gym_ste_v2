...
class StePFilterConvCenterExtremeEnv(StePFilterConvCenterBaseEnv):
...
register(
    id='StePFilterConvCenterExtremeEnv-v0',
    entry_point='gym_ste.envs:StePFilterConvCenterExtremeEnv',
)
