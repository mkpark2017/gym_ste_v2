...
import numpy as np
import math
from gym_ste.envs.ste_pf_veiled_vel_converge_center_base import *
...
class StePFilterVeiledVelConvCenterExtremeEnv(StePFilterVeiledVelConvCenterBaseEnv):
    metadata = {'render.modes': ['human', 'ansi'],
                'video.frames_per_second': 30}

    def __init__(self):
        StePFilterVeiledVelConvCenterBaseEnv.__init__(self)

        self.reset()

    def _set_init_state(self):
        StePFilterVeiledVelConvCenterBaseEnv._set_init_state(self)
...
register(
    id='StePFilterVeiledVelConvCenterExtremeEnv-v0',
    entry_point='gym_ste.envs:StePFilterVeiledVelConvCenterExtremeEnv',
)
