...
import numpy as np
import math
from gym_ste.envs.ste_pf_converge_base_3 import *
...
class StePFilterConvHardEnv3(StePFilterConvBaseEnv3):
    metadata = {'render.modes': ['human', 'ansi'],
                'video.frames_per_second': 30}

    def __init__(self):
        StePFilterConvBaseEnv3.__init__(self)
...
register(
    id='StePFilterConvHardEnv3-v0',
    entry_point='gym_ste.envs:StePFilterConvHardEnv3',
)
