...
import numpy as np
import math
from gym_ste.envs.ste_pf_converge_infotaxis_base import *
...
class StePFilterConvInfotaxisExtremeMatEnv(StePFilterConvInfotaxisBaseEnv):
    metadata = {'render.modes': ['human', 'ansi'],
                'video.frames_per_second': 30}

    def __init__(self):
        StePFilterConvInfotaxisBaseEnv.__init__(self)
...
register(
    id='StePFilterConvInfotaxisExtremeMatEnv-v0',
    entry_point='gym_ste.envs:StePFilterConvInfotaxisExtremeMatEnv',
)
