...
class StePFilterRelativeConvHardEnv(StePFilterRelativeConvBaseEnv):
...
register(
    id='StePFilterRelativeConvHardEnv-v0',
    entry_point='gym_ste.envs:StePFilterRelativeConvHardEnv',
)
