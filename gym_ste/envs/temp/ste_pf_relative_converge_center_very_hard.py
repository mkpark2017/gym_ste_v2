...
import numpy as np
import math
from gym_ste.envs.ste_pf_relative_converge_center_base import *
...
class StePFilterRelativeConvCenterVeryHardEnv(StePFilterRelativeConvCenterBaseEnv):
    metadata = {'render.modes': ['human', 'ansi'],
                'video.frames_per_second': 30}

    def __init__(self):
        StePFilterRelativeConvCenterBaseEnv.__init__(self)
...
register(
    id='StePFilterRelativeConvCenterVeryHardEnv-v0',
    entry_point='gym_ste.envs:StePFilterRelativeConvCenterVeryHardEnv',
)
