...
class StePFilterBaseEnv2(BasicSteEnv):
...
#        etc_low_state = np.array([-1, 0, 0, -1, 0, 0, 0]) # [wind_direction, wind speed (m/s), duration time, last action (only direction), last concentration, concentration (max 100 mg/m^3), highest conc]
        etc_low_state = np.array([-1, 0, 0, 0, 0, -1, 0, 0, 0]) # [wind_direction, wind speed (m/s), duration time, current location, last action (only direction), last concentration, concentration (max 100 mg/m^3), highest concentration])
