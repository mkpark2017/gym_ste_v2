...
import numpy as np
import math
from gym_ste.envs.ste_pf_base_2 import *
...
class StePFilterHardEnv2(StePFilterBaseEnv2):
    metadata = {'render.modes': ['human', 'ansi'],
                'video.frames_per_second': 30}

    def __init__(self):
        StePFilterBaseEnv2.__init__(self)
...
register(
    id='StePFilterHardEnv2-v0',
    entry_point='gym_ste.envs:StePFilterHardEnv2',
)
