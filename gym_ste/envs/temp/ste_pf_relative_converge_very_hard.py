...
import numpy as np
import math
from gym_ste.envs.ste_pf_relative_converge_base import *
...
class StePFilterRelativeConvVeryHardEnv(StePFilterRelativeConvBaseEnv):
    metadata = {'render.modes': ['human', 'ansi'],
                'video.frames_per_second': 30}

    def __init__(self):
        StePFilterRelativeConvBaseEnv.__init__(self)
...
register(
    id='StePFilterRelativeConvVeryHardEnv-v0',
    entry_point='gym_ste.envs:StePFilterRelativeConvVeryHardEnv',
)
