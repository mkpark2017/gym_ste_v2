...
import numpy as np
import math
from gym_ste.envs.ste_pf_converge_base_2 import *
...
class StePFilterConvHardEnv2(StePFilterConvBaseEnv2):
    metadata = {'render.modes': ['human', 'ansi'],
                'video.frames_per_second': 30}

    def __init__(self):
        StePFilterConvBaseEnv2.__init__(self)
...
register(
    id='StePFilterConvHardEnv2-v0',
    entry_point='gym_ste.envs:StePFilterConvHardEnv2',
)
