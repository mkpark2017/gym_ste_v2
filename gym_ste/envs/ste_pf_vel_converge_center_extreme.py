...
class StePFilterVelConvCenterExtremeEnv(StePFilterVelConvCenterBaseEnv):
...
register(
    id='StePFilterVelConvCenterExtremeEnv-v0',
    entry_point='gym_ste.envs:StePFilterVelConvCenterExtremeEnv',
)
