...
class StePFilterConvInfotaxisExtremeEnv(StePFilterConvInfotaxisBaseEnv):
...
register(
    id='StePFilterConvInfotaxisExtremeEnv-v0',
    entry_point='gym_ste.envs:StePFilterConvInfotaxisExtremeEnv',
)
