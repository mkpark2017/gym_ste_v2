...
import numpy as np
import math
from gym_ste.envs.ste_est_vel_base import *
...
class SteEstVelExtremeEnv(SteEstVelBaseEnv):
    metadata = {'render.modes': ['human', 'ansi'],
                'video.frames_per_second': 30}

    def __init__(self):
        SteEstVelBaseEnv.__init__(self)

        self.reset()

    def _set_init_state(self):
        SteEstVelBaseEnv._set_init_state(self)
...
register(
    id='SteEstVelExtremeEnv-v0',
    entry_point='gym_ste.envs:SteEstVelExtremeEnv',
)
