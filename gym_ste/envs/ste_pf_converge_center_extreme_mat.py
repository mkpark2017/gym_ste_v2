...
import numpy as np
import math
from gym_ste.envs.ste_pf_converge_center_base import *
...
class StePFilterConvCenterExtremeMatEnv(StePFilterConvCenterBaseEnv):
...
register(
    id='StePFilterConvCenterExtremeMatEnv-v0',
    entry_point='gym_ste.envs:StePFilterConvCenterExtremeMatEnv',
)
