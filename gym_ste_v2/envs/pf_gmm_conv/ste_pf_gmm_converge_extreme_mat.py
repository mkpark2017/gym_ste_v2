...
import numpy as np
import math
from gym_ste_v2.envs.pf_gmm_conv.ste_pf_gmm_converge_base import *
...
class StePfGmmConvExtMatEnv(BaseEnv):
...
register(
    id='StePfGmmConvExtMatEnv-v0',
    entry_point='gym_ste_v2.envs.pf_gmm_conv:StePfGmmConvExtMatEnv',
)
