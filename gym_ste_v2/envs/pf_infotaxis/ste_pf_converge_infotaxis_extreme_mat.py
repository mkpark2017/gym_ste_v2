...
import numpy as np
import math
from gym_ste_v2.envs.pf_infotaxis.ste_pf_converge_infotaxis_base import *
...
class StePfConvInfotaxisExtMatEnv(BaseEnv):
...
register(
    id='StePfConvInfotaxisExtMatEnv-v0',
    entry_point='gym_ste_v2.envs.pf_infotaxis:StePfConvInfotaxisExtMatEnv',
)
