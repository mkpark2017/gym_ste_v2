...
class StePFilterConvInfotaxisHardEnv(StePFilterConvInfotaxisBaseEnv):
...
register(
    id='StePFilterConvInfotaxisHardEnv-v0',
    entry_point='gym_ste.envs:StePFilterConvInfotaxisHardEnv',
)
