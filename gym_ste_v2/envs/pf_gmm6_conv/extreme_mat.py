...
import numpy as np
import math
from gym_ste_v2.envs.pf_gmm6_conv.base import *
...
class StePfGmm6ConvExtMatEnv(BaseEnv):
...
register(
    id='StePfGmm6ConvExtMatEnv-v0',
    entry_point='gym_ste_v2.envs.pf_gmm6_conv:StePfGmm6ConvExtMatEnv',
)
