...
class StePFilterConvCenterVeryHardEnv(StePFilterConvCenterBaseEnv):
...
register(
    id='StePFilterConvCenterVeryHardEnv-v0',
    entry_point='gym_ste.envs:StePFilterConvCenterVeryHardEnv',
)
